...
class AdminKanbanBoard extends KanbanBoard
{
    ...
    // --- FUNGSI KLIK KARTU (Penting biar bisa pindah halaman) ---
    ...
    public function getTitle(): string | Htmlable
    {
        ...
        // URL kembali ke daftar project Admin
        $backUrl = url('/admin/projects');
    ...
    public function onStatusChanged(int|string $recordId, string $status, array $fromOrderedIds, array $toOrderedIds): void
    {
        ...
        if ($project) {
            // --- LOGIKA UPDATE STATUS PROJECT OTOMATIS ---
            ...
            $usersToNotify = $project->members->push($project->leader)
    ...
    protected function getHeaderActions(): array
    {
        return [
            ...
            Action::make('createTask')
                ...
                ->url(fn (): string => \App\Filament\Resources\TaskResource::getUrl('create', [
